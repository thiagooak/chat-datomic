...
```
<pre class="src src-java">jane = db.entity(42)
```
...
```
<pre class="src src-java"><span style="color: #b22222;">// </span><span style="color: #b22222;">returns "Jane"</span>
firstName = jane.get(<span style="color: #8b2252;">":person/firstName"</span>)
```
...
```
<pre class="src src-java"><span style="color: #b22222;">// </span><span style="color: #b22222;">returns 42</span>
id = jane.get(<span style="color: #8b2252;">":db/id"</span>)
```
...
```
<pre class="src src-java">address = jane.get(<span style="color: #8b2252;">":person/address"</span>)
```
...
```
<pre class="src src-java"><span style="color: #b22222;">// </span><span style="color: #b22222;">empty, given the example data</span>
peopleJaneLikes = jane.get(<span style="color: #8b2252;">":person/likes"</span>)
```
...
```
<pre class="src src-java"><span style="color: #b22222;">// </span><span style="color: #b22222;">returns set containing John</span>
peopleWhoLikeJane = jane.get(<span style="color: #8b2252;">":person/_likes"</span>)
```
...
```
<pre class="src src-java">db = entity.db()
```
