...
```
<pre class="example" id="org68fa625">
...
```
<pre class="example" id="org53124d4">
...
```
<pre class="example" id="orge2bad93">
...
```
<pre class="example" id="org4360f9f">
...
```
<pre class="src src-js">[{<span style="color: #8b2252;">"name"</span>: <span style="color: #8b2252;">"<group-name>"</span>,
  <span style="color: #8b2252;">"type"</span>: <span style="color: #8b2252;">"<group-type>"</span>,
  <span style="color: #8b2252;">"endpoints"</span>:
  [{<span style="color: #8b2252;">"type"</span>: <span style="color: #8b2252;">"<endpoint-type>"</span>,
    <span style="color: #8b2252;">"api-gateway-endpoint"</span>: <span style="color: #8b2252;">"<endpoint-address>"</span>,
    <span style="color: #8b2252;">"api-gateway-id"</span>:<span style="color: #8b2252;">" <gateway-id>"</span>,
    <span style="color: #8b2252;">"api-gateway-name"</span>: <span style="color: #8b2252;">"<gateway-name>"</span>},
   ...],
  <span style="color: #8b2252;">"cft-version"</span>: <span style="color: #8b2252;">"<cloudformation-version>"</span>,
  <span style="color: #8b2252;">"cloud-version"</span>: <span style="color: #8b2252;">"<cloud-version>"</span>},
 ...]
```
...
```
<pre class="example" id="org9fe0296">
...
- <a id="client-access"></a>access  
    ...
    ```
    <pre class="example" id="org03f7d7e">
...
```
<pre class="example" id="orgc6305a2">
...
```
<pre class="example" id="org0cf8b50">
...
```
<pre class="example" id="org424da01">
...
- <a id="solo-up"></a>up  
    ...
    ```
    <pre class="example" id="org79d6ddd">
...
- <a id="solo-down"></a>down  
    ...
    ```
    <pre class="example" id="orgffd4dae">
...
- <a id="solo-reset"></a>reset  
    ...
    ```
    <pre class="example" id="org55774c7">
...
- <a id="analytics-access"></a>access  
    ...
    ```
    <pre class="example" id="orga4a7d13">
...
- <a id="analytics-sync"></a>sync  
    ...
    ```
    <pre class="example" id="org7d507af">
