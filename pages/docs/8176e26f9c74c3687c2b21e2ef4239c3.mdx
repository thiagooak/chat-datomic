...
```
<pre class="src src-clojure">[{<span style="color: #008b8b;">:db/excise</span> 42}]
```
...
```
<pre class="src src-clojure">[{<span style="color: #008b8b;">:db/excise</span> 42
  <span style="color: #008b8b;">:db.excise/attrs</span> [<span style="color: #008b8b;">:person/name</span> <span style="color: #008b8b;">:person/email</span>]}]
```
...
```
<pre class="src src-clojure">[{<span style="color: #008b8b;">:db/excise</span> <span style="color: #008b8b;">:event/user</span>
  <span style="color: #008b8b;">:db.excise/before</span> #inst <span style="color: #8b2252;">"2012"</span>}
 {<span style="color: #008b8b;">:db/excise</span> <span style="color: #008b8b;">:event/category</span>
  <span style="color: #008b8b;">:db.excise/before</span> #inst <span style="color: #8b2252;">"2012"</span>}
 {<span style="color: #008b8b;">:db/excise</span> <span style="color: #008b8b;">:event/description</span>
  <span style="color: #008b8b;">:db.excise/before</span> #inst <span style="color: #8b2252;">"2012"</span>}]
```
...
```
<pre class="src src-clojure">[{<span style="color: #008b8b;">:db/excise</span> <span style="color: #008b8b;">:event/user</span>
  <span style="color: #008b8b;">:db.excise/beforeT</span> 1100}
 {<span style="color: #008b8b;">:db/excise</span> <span style="color: #008b8b;">:event/category</span>
  <span style="color: #008b8b;">:db.excise/beforeT</span> 1100}
 {<span style="color: #008b8b;">:db/excise</span> <span style="color: #008b8b;">:event/description</span>
  <span style="color: #008b8b;">:db.excise/beforeT</span> 1100}]
...
```
<pre class="src src-java">Peer.query(<span style="color: #ff0000; font-weight: bold;">"</span><span style="color: #8b2252;">[:find ?e</span>
    :in \$ ?e
    :where [_ :db/excise ?e]<span style="color: #ff0000; font-weight: bold;">"</span><span style="color: #8b2252;">,</span>
  db,
  42)
```
