...
```
<pre class="src src-java">db.datoms(<span style="color: #228b22;">AVET</span>, <span style="color: #8b2252;">":account/balance"</span>);
```
...
```
<pre class="src src-java"><span style="color: #b22222;">// </span><span style="color: #b22222;">lazily iterate the entire database!</span>
db.datoms(<span style="color: #228b22;">EAVT</span>);
```
