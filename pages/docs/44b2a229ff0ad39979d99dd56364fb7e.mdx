...
```
<pre class="src src-clojure">(<span style="color: #483d8b;">->></span> (d/datoms db
               {<span style="color: #008b8b;">:index</span> <span style="color: #008b8b;">:avet</span>
                <span style="color: #008b8b;">:components</span> [<span style="color: #008b8b;">:inv/sku</span>]})
     (<span style="color: #a0522d;">take</span> 3)
     (<span style="color: #a0522d;">map</span> <span style="color: #008b8b;">:v</span>))
```



```
<pre class="src src-clojure">=> (<span style="color: #8b2252;">"SKU-0"</span> <span style="color: #8b2252;">"SKU-1"</span> <span style="color: #8b2252;">"SKU-10"</span>)
```
...
```
<pre class="src src-clojure">(<span style="color: #483d8b;">->></span> (d/index-range
      db
      {<span style="color: #008b8b;">:attrid</span> <span style="color: #008b8b;">:inv/sku</span>
       <span style="color: #008b8b;">:start</span> <span style="color: #8b2252;">"SKU-42"</span>
       <span style="color: #008b8b;">:end</span> <span style="color: #8b2252;">"SKU-44"</span>})
     (<span style="color: #a0522d;">map</span> <span style="color: #008b8b;">:v</span>))
```
...
```
<pre class="src src-clojure">=> (<span style="color: #8b2252;">"SKU-42"</span> <span style="color: #8b2252;">"SKU-43"</span>)
```