...
```
<pre class="src src-sh">./presto --server localhost:8989 --catalog <my-catalog> --schema <db-name>
```
...
```
<pre class="src src-sh">./presto --server localhost:8989 --catalog tomhanks --schema mbrainz
```
...
```
<pre class="src src-sql">show schemas;
...
```
<pre class="src src-sh">presto> show tables;
```



```
<pre class="src src-sql">           <span style="color: #a020f0;">Table</span>           
<span style="color: #b22222;">---------------------------</span>
 abstractrelease           
