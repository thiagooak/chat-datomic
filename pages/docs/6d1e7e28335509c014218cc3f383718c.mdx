...
```
<pre class="src src-clojure">(<span style="color: #a020f0;">def</span> <span style="color: #0000ff;">commando-id</span> 
  (<span style="color: #a0522d;">ffirst</span> (d/q '[<span style="color: #008b8b;">:find</span> ?e 
                 <span style="color: #008b8b;">:where</span> [?e <span style="color: #008b8b;">:movie/title</span> <span style="color: #8b2252;">"Commando"</span>]] 
                db)))
```
...
```
<pre class="src src-clojure">=> [[<span style="color: #8b2252;">"Commando"</span> 1985 <span style="color: #8b2252;">"future governor"</span>] [<span style="color: #8b2252;">"The Goonies"</span> 1985 <span style="color: #8b2252;">"action/adventure"</span>]]
```
...
```
<pre class="src src-clojure"><span style="color: #008b8b;">:db-before</span> {<span style="color: #008b8b;">:database-id</span> <span style="color: #8b2252;">"58a47389-f1ab-4d81-85b6-715cecde9bac"</span>, 
...
<span style="color: #008b8b;">:db-after</span> {<span style="color: #008b8b;">:database-id</span> <span style="color: #8b2252;">"58a47389-f1ab-4d81-85b6-715cecde9bac"</span>, 
           <span style="color: #008b8b;">:t</span> 1001, 
           <span style="color: #008b8b;">:next-t</span> 1005, 
           <span style="color: #008b8b;">:history</span> false}
```
...
```
<pre class="src src-clojure">db
```



```
<pre class="src src-clojure">=> {<span style="color: #008b8b;">:t</span> 1005, <span style="color: #008b8b;">:next-t</span> 1006, <span style="color: #008b8b;">:db-name</span> <span style="color: #8b2252;">"hello"</span>, <span style="color: #008b8b;">:database-id</span> <span style="color: #8b2252;">"5a381758-6e47-4504-aa08-07067b5c241a"</span>, <span style="color: #008b8b;">:type</span> <span style="color: #008b8b;">:datomic.client/db</span>}
```
...
```
<pre class="src src-clojure">user=> (<span style="color: #a020f0;">def</span> <span style="color: #0000ff;">old-db</span> (d/as-of db 1004))
```
