...
(d/pull db '[*] [<span style="color: #008b8b;">:item/id</span> <span style="color: #8b2252;">"DLC-042"</span>])
```
...
{<span style="color: #008b8b;">:db/id</span> 55301036830621764, 
...
(d/pull as-of-eoy-2013 '[*] [<span style="color: #008b8b;">:item/id</span> <span style="color: #8b2252;">"DLC-042"</span>])
```
...
(d/pull since-2014 '[*] [<span style="color: #008b8b;">:item/id</span> <span style="color: #8b2252;">"DLC-042"</span>])
```



```
<pre class="src src-clojure">=> #<span style="color: #008b8b;">:db</span>{<span style="color: #008b8b;">:id</span> nil} <span style="color: #b22222;">;; </span><span style="color: #b22222;">!!!</span>
```
...
```
<pre class="src src-clojure">(d/pull since-2014 '[*] (<span style="color: #008b8b;">:db/id</span> (d/pull db [<span style="color: #008b8b;">:db/id</span>] [<span style="color: #008b8b;">:item/id</span> <span style="color: #8b2252;">"DLC-042"</span>])))
```
