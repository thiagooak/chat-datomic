...
```
<pre class="src src-clojure">(d/transact conn {<span style="color: #008b8b;">:tx-data</span> [...] <span style="color: #008b8b;">:io-context</span> <span style="color: #008b8b;">:tx/example</span>)
```
...
```
<pre class="src src-clojure">(d/q {<span style="color: #008b8b;">:query</span> '[<span style="color: #008b8b;">:find</span> (<span style="color: #a0522d;">count</span> ?a)
...
```
<pre class="src src-clojure">{<span style="color: #008b8b;">:io-stats</span> {<span style="color: #008b8b;">:io-context</span> <span style="color: #008b8b;">:artist/by-name</span>,
            <span style="color: #008b8b;">:api</span> <span style="color: #008b8b;">:query</span>,
            <span style="color: #008b8b;">:api-ms</span> 105.08,
            <span style="color: #008b8b;">:reads</span> {<span style="color: #008b8b;">:dir</span> 1,
                    <span style="color: #008b8b;">:avet</span> 2,
                    <span style="color: #008b8b;">:valcache-direct</span> 2,
                    <span style="color: #008b8b;">:efs</span> 2,
                    <span style="color: #008b8b;">:efs-ms</span> 26.27,
                    <span style="color: #008b8b;">:valcache</span> 2,
                    <span style="color: #008b8b;">:dir-load</span> 1,
                    <span style="color: #008b8b;">:valcache-ms</span> 50.57,
                    <span style="color: #008b8b;">:avet-load</span> 2,
                    <span style="color: #008b8b;">:ocache</span> 2}},
 <span style="color: #008b8b;">:ret</span> [[1]]}
```
