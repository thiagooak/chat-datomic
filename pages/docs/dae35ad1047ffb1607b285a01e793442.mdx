...
```
<pre class="src src-clojure">(<span style="color: #a020f0;">def</span> <span style="color: #0000ff;">cors-headers</span> {<span style="color: #8b2252;">"Access-Control-Allow-Origin"</span> <span style="color: #8b2252;">"*"</span>
                   <span style="color: #8b2252;">"Access-Control-Allow-Methods"</span> <span style="color: #8b2252;">"GET, PUT, PATCH, POST, DELETE, OPTIONS"</span>
                   <span style="color: #8b2252;">"Access-Control-Allow-Headers"</span> <span style="color: #8b2252;">"Authorization, Content-Type"</span>})
```
