    ...
    <span style="color: #8b2252;">"Statement"</span>: [
        {
            <span style="color: #8b2252;">"Action"</span>: [
                <span style="color: #8b2252;">"s3:GetObject"</span>
            ],
            <span style="color: #8b2252;">"Resource"</span>: [
                <span style="color: #8b2252;">"$(S3DatomicArn)/$(SystemName)/datomic/access/*"</span>
            ],
            <span style="color: #8b2252;">"Effect"</span>: <span style="color: #8b2252;">"Allow"</span>
        },
        {
            <span style="color: #8b2252;">"Action"</span>: [
                <span style="color: #8b2252;">"s3:PutObject"</span>,
                <span style="color: #8b2252;">"s3:DeleteObject"</span>
            ],
            <span style="color: #8b2252;">"Resource"</span>: [
                <span style="color: #8b2252;">"$(S3DatomicArn)/$(SystemName)/datomic/access/public-keys/*"</span>
            ],
            <span style="color: #8b2252;">"Effect"</span>: <span style="color: #8b2252;">"Allow"</span>
        },
        {
            <span style="color: #8b2252;">"Action"</span>: [
                <span style="color: #8b2252;">"ec2:DescribeInstances"</span>,
            ],
        ...
        {
            <span style="color: #8b2252;">"Action"</span>: [
                <span style="color: #8b2252;">"ec2:RebootInstances"</span>
            ],
            <span style="color: #8b2252;">"Resource"</span>: <span style="color: #8b2252;">"*"</span>,
            <span style="color: #8b2252;">"Effect"</span>: <span style="color: #8b2252;">"Allow"</span>,
            <span style="color: #8b2252;">"Condition"</span>: {
              <span style="color: #8b2252;">"StringEquals"</span>: {
                <span style="color: #8b2252;">"ec2:ResourceTag/datomic:system"</span>: <span style="color: #8b2252;">"$(SystemName)"</span>
              }
           }
        }
    ]
