...
Install RStudio follwing the instructions from the [RStudio Download Page](https://www.rstudio.com/products/rstudio/download/).

Launch RStudio and install the RPresto package <https://github.com/prestodb/RPresto> by running:

```
<pre class="src src-R">install.packages('RPresto')
```
...
```
<pre class="src src-R">library('DBI')
