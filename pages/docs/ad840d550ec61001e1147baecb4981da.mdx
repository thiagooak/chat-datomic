...
```
<pre class="src src-clojure">(<span style="color: #a020f0;">def</span> <span style="color: #0000ff;">find-expr</span> '[<span style="color: #008b8b;">:find</span> (pull ?e details-expr)
                 <span style="color: #008b8b;">:in</span> $ details-expr
                 <span style="color: #008b8b;">:where</span> [?e <span style="color: #008b8b;">:artist/name</span>]])
(<span style="color: #a020f0;">def</span> <span style="color: #0000ff;">details-expr</span> [<span style="color: #008b8b;">:artist/name</span> <span style="color: #008b8b;">:artist/startYear</span>])
...
```
<pre class="src src-clojure">[<span style="color: #008b8b;">:find</span> ?e ?name ?year
 <span style="color: #008b8b;">:where</span>
 [?e <span style="color: #008b8b;">:artist/name</span> ?name]
 [(get-else $ ?e <span style="color: #008b8b;">:artist/startYear</span> <span style="color: #8b2252;">"Unknown"</span>) ?year]]
```
