...
```
<pre class="example" id="orgadef389">
...
```
<pre class="example" id="org087e467">
...
```
<pre class="src src-sh">metrics-callback=my.pkg.CallbackClass.handler
```
...
```
<pre class="src src-sh">metrics-callback=my.ns/handler
```
...
```
<pre class="src src-clojure">{<span style="color: #008b8b;">:HeartbeatMsec</span> {<span style="color: #008b8b;">:lo</span> 5000, <span style="color: #008b8b;">:hi</span> 5001, <span style="color: #008b8b;">:sum</span> 55009, <span style="color: #008b8b;">:count</span> 11}, <span style="color: #008b8b;">:AvailableMB</span> 921.0}
```
