...
```
<pre class="src src-shell-script">bin/console -p port alias transactor-uri-without-db [alias transactor-uri-without-db]+
```
...
```
<pre class="src src-shell-script">bin/console -p 8080 dev datomic:dev://localhost:4334/
```
