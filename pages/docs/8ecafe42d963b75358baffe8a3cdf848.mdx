...
```
<pre class="src src-sample">ActiveMQConnectionTimedOutException AMQ119013: Timed out waiting to receive cluster topology. Group:null  org.apache.activemq.artemis.core.client.impl.ServerLocatorImpl.createSessionFactory (ServerLocatorImpl.java:816)
```
...
```
<pre class="src src-sample">HornetQConnectionTimedOutException HQ119013: Timed out waiting to receive cluster topology. Group:null  org.hornetq.core.client.impl.ServerLocatorImpl.createSessionFactory (ServerLocatorImpl.java:946)
```
...
```
<pre class="src src-clojure">[org.clojure/clojure <span style="color: #8b2252;">"1.7.0"</span>]
[com.datomic/datomic-pro <span style="color: #8b2252;">"0.9.5327"</span>
 <span style="color: #008b8b;">:exclusions</span> [... org.clojure/clojure]]
```
...
<pre class="src src-xml"><<span style="color: #0000ff;">dependency</span>>
  ...
  <<span style="color: #0000ff;">version</span>>1.7.0</<span style="color: #0000ff;">version</span>>
...
<<span style="color: #0000ff;">dependency</span>>
  ...
  <<span style="color: #0000ff;">version</span>>0.9.5327</<span style="color: #0000ff;">version</span>>
...
```
<pre class="src src-clojure">[org.clojure/clojure <span style="color: #8b2252;">"1.6.0"</span>]
[com.datomic/datomic-pro <span style="color: #8b2252;">"0.9.4815.10"</span>
 <span style="color: #008b8b;">:exclusions</span> [... org.clojure/clojure]]
```
...
<pre class="src src-xml"><<span style="color: #0000ff;">dependency</span>>
  <<span style="color: #0000ff;">groupId</span>>org.clojure</<span style="color: #0000ff;">groupId</span>>
  <<span style="color: #0000ff;">artifactId</span>>clojure</<span style="color: #0000ff;">artifactId</span>>
  <<span style="color: #0000ff;">version</span>>1.6.0</<span style="color: #0000ff;">version</span>>
</<span style="color: #0000ff;">dependency</span>>
<<span style="color: #0000ff;">dependency</span>>
  <<span style="color: #0000ff;">groupId</span>>com.datomic</<span style="color: #0000ff;">groupId</span>>
  <<span style="color: #0000ff;">artifactId</span>>datomic-pro</<span style="color: #0000ff;">artifactId</span>>
  <<span style="color: #0000ff;">version</span>>0.9.4815.10</<span style="color: #0000ff;">version</span>>
  <<span style="color: #0000ff;">exclusions</span>>
    <<span style="color: #0000ff;">exclusion</span>>
      <<span style="color: #0000ff;">groupId</span>>org.clojure</<span style="color: #0000ff;">groupId</span>>
      <<span style="color: #0000ff;">artifactId</span>>clojure</<span style="color: #0000ff;">artifactId</span>>
...
```
<pre class="src src-example">java.lang.IllegalArgumentException: No matching clause: 3
...
```
<pre class="src src-example">memory-index-threshold=32m
...
```
<pre class="src src-sample">java.lang.NullPointerException
...
```
<pre class="src src-java"><span style="color: #228b22;">NullPointerException</span>   <span style="color: #008b8b;">java</span>.<span style="color: #008b8b;">util</span>.UUID.<span style="color: #a0522d;">fromString</span>
```
...
```
<pre class="src src-shx">bin/datomic revert-to-log-version-1 {your-database-uri}
```
...
```
<pre class="src src-clojure">[org.clojure/clojure <span style="color: #8b2252;">"1.5.1"</span>]
[com.datomic/datomic-pro <span style="color: #8b2252;">"0.8.3862"</span>
 <span style="color: #008b8b;">:exclusions</span> [... org.clojure/clojure]]
```
...
<pre class="src src-xml"><<span style="color: #0000ff;">dependency</span>>
  <<span style="color: #0000ff;">groupId</span>>org.clojure</<span style="color: #0000ff;">groupId</span>>
  <<span style="color: #0000ff;">artifactId</span>>clojure</<span style="color: #0000ff;">artifactId</span>>
  <<span style="color: #0000ff;">version</span>>1.5.1</<span style="color: #0000ff;">version</span>>
</<span style="color: #0000ff;">dependency</span>>
<<span style="color: #0000ff;">dependency</span>>
  <<span style="color: #0000ff;">groupId</span>>com.datomic</<span style="color: #0000ff;">groupId</span>>
  <<span style="color: #0000ff;">artifactId</span>>datomic-pro</<span style="color: #0000ff;">artifactId</span>>
  <<span style="color: #0000ff;">version</span>>0.8.3862</<span style="color: #0000ff;">version</span>>
  <<span style="color: #0000ff;">exclusions</span>>
    <<span style="color: #0000ff;">exclusion</span>>
      <<span style="color: #0000ff;">groupId</span>>org.clojure</<span style="color: #0000ff;">groupId</span>>
      <<span style="color: #0000ff;">artifactId</span>>clojure</<span style="color: #0000ff;">artifactId</span>>
