...
```
<pre class="src src-sh"><span style="color: #483d8b;">export</span> <span style="color: #a0522d;">AWS_SECRET_KEY</span>=<aws-secret-key>
```
...
```
<pre class="src src-sh">bin/datomic ensure-cf my-cf.properties my-cf.properties
```
...
```
<pre class="src src-sh">bin/datomic create-cf-template my-transactor.properties my-cf.properties cf-template.json
```
...
```
<pre class="src src-sh">bin/datomic create-cf-stack us-east-1 MyTransactor cf-template.json
```
...
```
<pre class="src src-sh">bin/datomic delete-cf-stack us-east-1 MyTransactor
```
...
<pre class="src src-js">{<span style="color: #8b2252;">"Statement"</span>:
 [{<span style="color: #8b2252;">"Resource"</span>:<span style="color: #8b2252;">"*"</span>,
   ...
   [<span style="color: #8b2252;">"cloudwatch:PutMetricData"</span>, <span style="color: #8b2252;">"cloudwatch:PutMetricDataBatch"</span>],
