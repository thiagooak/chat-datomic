...
```
<pre class="src src-clojure">[{<span style="color: #008b8b;">:person/name</span> <span style="color: #8b2252;">"Anna"</span> <span style="color: #008b8b;">:person/email</span> <span style="color: #8b2252;">"anna@example.com"</span>}]
```
